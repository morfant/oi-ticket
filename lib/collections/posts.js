...
validatePost = function (post) {
  ...
  if (!post.ticketPrice) errors.ticketPrice = "티켓가격 정보를 입력해 주세요. Please fill in a price.";
...
if (!post.duration) errors.duration = "소요시간을 입력해 주세요. Please fill in a duration.";
if (!post.contact) errors.contact = "공연문의 연락처를 입력해 주세요. Please fill in a contact.";
if (!post.description) errors.description = "작품 소개를 입력해 주세요. Pleas
*/
    ...
    check(postAttributes, {
      ...
      place: String,
      playDates: String,
      playDatesDetail: Match.Optional(String),
      ticketPrice: String,
      duration: String,
      contact: String,
      ageGrade: Match.Optional(String),
      sponsor: Match.Optional(String),
      production: Match.Optional(String),
      director: Match.Optional(String),
      original: Match.Optional(String),
      cast: Match.Optional(String),
      arrange: Match.Optional(String),
      description: String,
      synopsis: Match.Optional(String),
      staffs: Match.Optional(String),
      // imgId: String,
      // imgNum: Number
      includeImages: Array,
      state: Number,
